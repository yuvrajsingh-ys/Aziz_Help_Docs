...
The “tabs” currently present in  ZaamAIBot refer to the tabs on the left-hand sidebar of the main  ZaamAIBot dashboard. These include tabs such as Home, Bots, Inbox, Analytics, etc, and they help users in traversing the  ZaamAIBot platform, utilizing all the available features through a super-easy navigation sidebar.

The new “Custom Tabs” feature is designed to enhance platform functionality by allowing customers to add and connect their own websites as tabs within  ZaamAIBot. This enables a more personalized workspace, streamlining workflows and improving efficiency. This document provides a step-by-step guide on how to create and utilize “Custom Tabs.”

## **Steps to Create Custom Tabs:**

1. Login to your  ZaamAIBot Dashboard, and open the collapsible menu on the left-hand sidebar.
2. Click on the “**More**” tab, which will open up the Collapsible menu.
3. Click on “**Settings**” to open settings

   ![195 Custom Tabs  ZaamAIBot Resource Centre 1 Pn](/images/how-botpenguin-works/custom-tab/195.custom_tabs__ZaamAIBot_resource_centre-1.png)
4. Click on the “**Custom Tabs**” option on the top navigation bar, and the following screen should open up.

   ![195 Custom Tabs  ZaamAIBot Resource Centre 2 Pn](/images/how-botpenguin-works/custom-tab/195.custom_tabs__ZaamAIBot_resource_centre-2.png)
5. Click on “**Create Custom Tab**”, and enter all the details for the creation of the tab. The details include:
   ...
   - **Tab Location**: Select the location of the tab:
     ...
     ![195 Custom Tabs  ZaamAIBot Resource Centre 3 Pn](/images/how-botpenguin-works/custom-tab/195.custom_tabs__ZaamAIBot_resource_centre-3.png)
6. Click on “**Create Custom Tab**” to finish the construction of the custom tab. The tab will appear on the sidebar, and will open the previously entered URL upon clicking.
   ...
   ![195 Custom Tabs  ZaamAIBot Resource Centre 5 Pn](/images/how-botpenguin-works/custom-tab/195.custom_tabs__ZaamAIBot_resource_centre-4.png)
7. Upon the creation of the tab, it will appear in a table format on the “**Custom Tabs**” dashboard.
   ...
   ![195 Custom Tabs  ZaamAIBot Resource Centre 5 Pn](/images/how-botpenguin-works/custom-tab/195.custom_tabs__ZaamAIBot_resource_centre-5.png)
