...
<AccordionGroup>
  <Accordion title="How do we collect country, city, mobile number and other metadata?">
    1. ZaamAIBot fetches the country and city of a visitor from their IP address.
  ...
  <Accordion title="How can I call customers using the call feature in the Leads section?">
    ZaamAIBot offers an integration with Twilio to call your leads directly from the Inbox on your desktop. You must integrate Twilio with ZaamAIBot to set up this calling feature.
  </Accordion>
  ...
  <Accordion title="How to integrate Twilio?">
    ...
    If you need further assistance, contact us at [zaamglobaltech@gmail.com](mailto:zaamglobaltech@gmail.com).
  </Accordion>
