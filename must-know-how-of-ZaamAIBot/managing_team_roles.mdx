...
<Info>
  Please note: Only the King (Paid) plan have the feature of having more than one team member (i.e. three), if you need more than that, Please request the  ZaamAIBot support team for the same.
</Info>
...
**Team Users** are client team members with assigned roles and permissions within the platform. These roles define what actions they can perform and what they can access, such as configuring chatbots, managing content, or viewing analytics. Team Users in  ZaamAIBot help streamline collaboration and access control in the chatbot building and management process.
...
In  ZaamAIBot, you can efficiently manage team roles and users to streamline access and permissions within your account. Here's a step-by-step guide on how to do it:

#### **Step 1: Access the  ZaamAIBot Dashboard**

- Log in to your  ZaamAIBot account and access the dashboard.
...
- Set up the role by providing the following details:
  ...
  - **Assign Permissions**: Customize permissions for this role based on your specific needs. Permissions are related to different modules within the  ZaamAIBot platform.
...
- Click "Create User" to add the new team member to your  ZaamAIBot account.
...
And there you have it\! You've successfully created a new role and added a new user to your  ZaamAIBot account. This streamlined management process helps you control access and permissions effectively.