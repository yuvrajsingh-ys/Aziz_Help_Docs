...
```
https://api.v7. ZaamAIBot.com/whatsapp-automation/wa/templates?apiKey=*API KEY*
```
...
```
curl --location --request GET 'https://api.v7. ZaamAIBot.com/whatsapp-automation/wa/templates?apiKey=*API KEY*' \\
