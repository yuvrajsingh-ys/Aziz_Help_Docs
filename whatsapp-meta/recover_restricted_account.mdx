...
2. Navigate to **All Tools**(represented as 3 horizontal lines)**\> Business Support Home**.
   ...
   ![231 Recovering Your Restricted Meta Account ZaamAIBot 1 Pn](/images/platform-guidelines-training/recovering-restricted-account/231.recovering_your_restricted_meta_account__ZaamAIBot-1.png)
...
4. Click on "**Account Overview**", sole icon of the left sidebar, to see all the related accounts.
   ...
   ![231 Recovering Your Restricted Meta Account  ZaamAIBot 2 Pn](/images/platform-guidelines-training/recovering-restricted-account/231.recovering_your_restricted_meta_account__ZaamAIBot-2.png)
5. The status of all the accounts will be shown. Click on the "**View Account**" to see the detailed summary of the issues.

   ![231 Recovering Your Restricted Meta Account  ZaamAIBot 3 Pn](/images/platform-guidelines-training/recovering-restricted-account/231.recovering_your_restricted_meta_account__ZaamAIBot-3.png)
...
7. Click on the "**Request Review**".
   ...
   ![231 Recovering Your Restricted Meta Account  ZaamAIBot 5 Pn](/images/platform-guidelines-training/recovering-restricted-account/231.recovering_your_restricted_meta_account__ZaamAIBot-4.png)
...
![231 Recovering Your Restricted Meta Account  ZaamAIBot 5 Pn](/images/platform-guidelines-training/recovering-restricted-account/231.recovering_your_restricted_meta_account__ZaamAIBot-5.png)
