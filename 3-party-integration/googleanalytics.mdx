---
title: "Integrate  ZaamAIBot with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  ZaamAIBot."
---

#### **Integration of Google Analytics with  ZaamAIBot**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  ZaamAIBot chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  ZaamAIBot:

**Step 1: Log in to  ZaamAIBot**

1. Navigate to your [ ZaamAIBot account](https://www. ZaamAIBot.com/).
...
To connect Google Analytics to your  ZaamAIBot account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  ZaamAIBot**

1. Go back to the  ZaamAIBot integration page where you clicked **Connect** for Google Analytics.
