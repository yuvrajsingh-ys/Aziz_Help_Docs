---
title: "Integrate  ZaamAIBot with Zendesk CRM"
description: "This page contains the stepwise tutorial for the integration with  ZaamAIBot"
---

### **Why use Zendesk CRM?**

ZaamAIBot integrates with Zendesk to enhance customer support and improve ticket management. By combining  ZaamAIBot’s AI-driven chatbot with Zendesk’s customer service and helpdesk platform, businesses can automatically respond to customer queries, create and assign tickets, and track customer interactions in real-time. This integration helps streamline workflows, reduce response times, and ensure customer issues are resolved efficiently.
...
- **24/7 Availability:** Offer continuous support through  ZaamAIBot, ensuring customers get assistance at any time, day or night.
...
click the ‘Connect’ Button to complete integration of  ZaamAIBot with Zendesk.
...
a. Now, as connection of the  ZaamAIBot and Zendesk is established, you need

to map **parameters (fields) of Zendesk** to the user response of the  ZaamAIBot question.
...
ZaamAIBot to the Zendesk’s Name field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to Zendesk fields.
...
Once you have established a connection between ZaamAIBot and **Zendesk**, and the mapping is complete, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  ZaamAIBot dashboard as well as in the Zendesk you have integrated.
