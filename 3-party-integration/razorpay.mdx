---
title: "Integrate  ZaamAIBot with Razorpay"
description: "This page contains al the necessary information on how you can interate the Razorpay with Botepenguin"
---

### **Prerequisites**

To successfully integrate Razorpay with  ZaamAIBot, you will need:

- A ** ZaamAIBot** account.
- A **Razorpay** account.
- A **WhatsApp bot**

This integration enables your WhatsApp bot created on  ZaamAIBot to collect payments via Razorpay.

#### **Step 1: Login to  ZaamAIBot and Select WhatsApp Bot**

1. Go to [ ZaamAIBot](https://www. ZaamAIBot.com/) and log into your account.
...
To connect Razorpay with  ZaamAIBot, you need the **Client ID** and **Client Secret** from your Razorpay account.
...
#### **Step 4: Connect Razorpay to  ZaamAIBot**
...
4. Go back to  ZaamAIBot and copy the **Webhook URL** from the integration settings.
...
1. Navigate back to your  ZaamAIBot bot editor.
...
Your  ZaamAIBot WhatsApp bot is now successfully integrated with Razorpay. You can collect payments seamlessly and track payment events through the configured webhooks. This integration ensures a smooth payment experience for your users directly through WhatsApp.   