...
- **Seamless Event Management:** Easily create, reschedule, or cancel events with the help of  ZaamAIBot, directly syncing with Google Calendar.
...
#### **Why Integrate Google Calendar with  ZaamAIBot?**
...
### **Steps to Integrate Google Calendar with  ZaamAIBot**

 1. Login to your  ZaamAIBot account. Now, select and click the chatbot you want to integrate with Google Calendar. Click on the “**Third-party Apps Integration”.**
...
A lot of questions might arise when integrating  ZaamAIBot with Google Calendar. Some of the most popular questions are answered below:
...
<AccordionGroup>
  ...
  <Accordion title="Can I integrate with a shared or a team calendar instead of a personal calendar">
    At present,  ZaamAIBot only supports integration with the primary calendar associated with the connected Google account. Shared or team calendars are not natively supported unless added to the same Google account and made the default.
  </Accordion>
  ...
  <Accordion title="How do I properly configure the chatbot with gogle calendar?">
    ...
    1. **Integrate the bot with Google Calendar** via the Third-Party Integrations section in your  ZaamAIBot dashboard.
