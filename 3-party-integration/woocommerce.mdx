---
title: "Integrate  ZaamAIBot with WooCommerce"
description: "This page contains the stepwise tutorial for WooCommerce Integration with  ZaamAIBot."
---
...
### **Step 1 of 4: Login to your  ZaamAIBot Account and Select Application to Integrate:**

1. Login to your  ZaamAIBot account. Now, select and click the WhatsApp chatbot you want to integrate with WooCommerce. Click on the “**Third-party Apps Integration”.**
...
3. Add API URL: “https://api.v7. ZaamAIBot.com/whatsapp/woo-commerce/{{phoneNumberId}}”
...
<Info>
  You need to create a separate webhook for every information you want your chatbot to fetch. For example, for orders created, orders updated, and orders deleted, there are three separate webhooks. If you want to configure all of them, you should add the same in woo-commerce. In  ZaamAIBot, you can have separate configurations for orders updated with different statuses and one for orders created and orders deleted.
</Info>

### **Step 2.2 of 4: Find your Phone Number ID in  ZaamAIBot**
...
### **Step 3 of 4: Edit the integration configurations in  ZaamAIBot**
...
When an order is shipped,  ZaamAIBot can automatically notify customers with a **shipment confirmation message**.
...
Once you have established a connection between ** ZaamAIBot** and **the WooCommerce website, you are ready** for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  ZaamAIBot dashboard as well as in the WhatsApp chatbot sent messages.
