---
title: "Integrate  ZaamAIBot with Google Contacts"
description: "This page includes all the necessary information on how you can integrate the Google contacts with  ZaamAIBot in details"
---

### **Use of Google Contacts?**

 ZaamAIBot integrates with Google Contacts to streamline contact management and improve customer interaction. By syncing  ZaamAIBot’s AI-powered chatbot with Google Contacts, businesses can automatically capture, update, and manage contact information in real-time. This integration allows for seamless data syncing, ensuring that customer profiles are always up-to-date and improving communication and follow-up processes.
...
### **Integrate  ZaamAIBot with Google Contacts**

 1. **Login to  ZaamAIBot:**
    - Start by logging into your  ZaamAIBot account.
 2. **\
    Navigate to the Bot:**
 ...
 6. **Login to Google Account:**
    - You will be prompted to log into your Google account. Ensure you use the Google account you want to link with  ZaamAIBot.
 7. **\
    Grant Permissions:**
    - Follow the on-screen instructions to grant  ZaamAIBot the necessary permissions to access your Google Contacts.
 8. **Map the Questions:**
...
11. **Check the Contact Section:**
    - In the "Contact" section of your  ZaamAIBot dashboard, you will see the demo leads created by the integration.
