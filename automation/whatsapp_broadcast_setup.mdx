...
2. When you select a template you will be asked to add header media which you can import from your system.
   ...
   ![41 Whatsapp Broadcast Setup  ZaamAIBot Resource Cent 1 Pn](/images/how-botpenguin-works/whatsapp-broadcast-setup/41.whatsapp_broadcast_setup_\_ZaamAIBot_resource_cent-1.png)
