...
To use the  ZaamAIBot APIs, You need to insure that you have following details with you.

A. **UUID** - You can get the UUID from the local web session storage as show in the image below:

![251 Website Contacts Meta Data  ZaamAIBot Resource C 1 Pn](/images/api-references/website-contact-metadata/251.website_contacts__meta_data__ZaamAIBot_resource_c-1.png)
...
https://page. ZaamAIBot.com/BotId/CustomerId
...
<script id=" ZaamAIBot-messenger-widget" src="https://cdn. ZaamAIBot.com/ ZaamAIBot.js" defer>BotId,CustomerId</script>
...
### **Create a lead in the  ZaamAIBot**
...
`PUT` `https://api.v7. ZaamAIBot.com/inbox/direct/lead`
...
`GET` `https://api.v7. ZaamAIBot.com/inbox/direct/chats`
    ...
    "data": [
        {
            ...
            "lastMessage": {
                ...
                "by": "bot",
                "text": "Welcome to  ZaamAIBot. I am here to help you."
            },
