...
The **Inbox User Import API** allows you to import WhatsApp contacts into the  ZaamAIBot platform. You can use this API to create or update WhatsApp contacts with various attributes and contact information.

#### **Base URL**

```
https://api.v7. ZaamAIBot.com/inbox/users/import
```
...
```
curl 'https://api.v7. ZaamAIBot.com/inbox/users/import' \
  -H 'Authorization: Bearer eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9...' \
  -H 'Content-Type: application/json' \
  -H 'Accept: */*' \
  -H 'Origin: https://app. ZaamAIBot.com' \
  -H 'Referer: https://app. ZaamAIBot.com/' \
...
The Inbox User Import API allows you to easily import user profiles into the  ZaamAIBot platform. Make sure to follow the authentication and data format guidelines for successful imports.
